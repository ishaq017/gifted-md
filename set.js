...
global.caption = "*©𝟐𝟎𝟐𝟓 𝛪𝐵 𝛥𝐹𝑅𝛪𝐷𝛪 𝟎𝟏𝟕*"; // Input Yours custom...(Maintain font for Flow)
...
global.footer = "*𝛲𝛩𝑊𝛯𝑅𝛯𝐷 𝐵𝑌  𝛪𝐵 𝛥𝐹𝑅𝛪𝐷𝛪*"; // Input Yours custom...(Maintain font for Flow)
...
STATUS_REPLY_MSG: process.env.STATUS_REPLY_MSG || "✅️ Status Viewed by 𝛪𝐵 𝛥𝐹𝑅𝛪𝐷𝛪!", // // Input Yours custom...
MODE: process.env.MODE || "public", // Put private or public or inbox or groups
OWNER_NUMBER: process.env.OWNER_NUMBER || "923459205595", // Only 1 owner Number Here, others Add to sudo numbers...
OWNER_NAME: process.env.OWNER_NAME || "𝛪𝐵 𝛥𝐹𝑅𝛪𝐷𝛪", // Input Yours custom...(Maintain font for Flow)
PACK_AUTHOR: process.env.PACK_AUTHOR || "𝛪𝐵 𝛥𝐹𝑅𝛪𝐷𝛪", // Added // Input Yours custom...
PACK_NAME: process.env.PACK_NAME || "𝛪𝐵 𝛥𝐹𝑅𝛪𝐷𝛪", // Added // Input Yours custom...
...
BOT_NAME: process.env.BOT_NAME || "𝛪𝐵 𝛥𝐹𝑅𝛪𝐷𝛪", // Input Yours custom...(Maintain font for Flow)
BOT_PIC: process.env.BOT_PIC || "https://files.catbox.moe/2p0mnq.jpg", // You can Replace with yours...
